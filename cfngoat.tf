...
encrypted = true
resource "aws_s3_bucket_public_access_block" "my_aws_s3_bucket_public_access_block_aws_s3_bucket_flow_bucket" {
  bucket             = aws_s3_bucket.flow_bucket.id
  ignore_public_acls = true
}
resource "aws_s3_bucket_public_access_block" "my_aws_s3_bucket_public_access_block_aws_s3_bucket_data_bucket" {
  bucket             = aws_s3_bucket.data_bucket.id
  ignore_public_acls = true
}
resource "aws_s3_bucket_public_access_block" "my_aws_s3_bucket_public_access_block_aws_s3_bucket_financials_bucket" {
  bucket             = aws_s3_bucket.financials_bucket.id
  ignore_public_acls = true
}
resource "aws_s3_bucket_public_access_block" "my_aws_s3_bucket_public_access_block_aws_s3_bucket_operations_bucket" {
  bucket             = aws_s3_bucket.operations_bucket.id
  ignore_public_acls = true
}
resource "aws_s3_bucket_public_access_block" "my_aws_s3_bucket_public_access_block_aws_s3_bucket_data_science_bucket" {
  bucket             = aws_s3_bucket.data_science_bucket.id
  ignore_public_acls = true
}
resource "aws_s3_bucket_public_access_block" "my_aws_s3_bucket_public_access_block_aws_s3_bucket_logs_bucket" {
